...
SDK_KEY             = b"BHcZ4sV2Zt3Jg97g6GJeRAkUSnwtW3JdjQRqBzEwoJMh"
LIB_FACE            = ctypes.cdll.LoadLibrary( os.path.abspath('.') + "/linux_so/libarcsoft_face.so" )
LIB_FACE_ENGINE     = ctypes.cdll.LoadLibrary( os.path.abspath('.') + "/linux_so/libarcsoft_face_engine.so" )
...
#内存操作的定义
malloc  = ctypes.CDLL(u'libc.so.6').malloc
malloc.restype = ctypes.c_void_p
memcpy  = ctypes.CDLL(u'libc.so.6').memcpy
free    = ctypes.CDLL(u'libc.so.6').free
